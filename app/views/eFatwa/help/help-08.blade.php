...
<span>@lang(sprintf('%s/app.help_documentation', Config::get('app_settings.theme')))</span>
</td>
<!--///////////////////////////////////////////////////////////////////////////////////////-->
<tr>
...
<span class="help-title">@lang(sprintf('%s/app.help_documentation', Config::get('app_settings.theme')))</span>
<hr color="#FFFFFF" width="100%" align="right">
<span class="help-textpics-pics">
<img src="{{ asset(sprintf('/assets/%s/images/help/help-07.jpg', Config::get('app_settings.theme'))) }}" alt="" class="help-img" />
</span>
